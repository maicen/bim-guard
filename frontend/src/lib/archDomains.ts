...
const DOOR_PROPERTIES: IfcPropertySuggestion[] = [
  ...
  { name: "ThresholdHeight", propertySet: "Pset_DoorCommon", label: "Threshold Height", unit: "mm" },
  ...
  { name: "FireRatedGlazingArea", propertySet: "Pset_DoorCommon", label: "Fire-Rated Glazing Area" },
