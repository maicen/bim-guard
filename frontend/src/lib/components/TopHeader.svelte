...
<header
  class="h-16 border-b border-slate-800 bg-slate-950/60 apple-blur sticky top-0 z-30 px-6 flex items-center justify-between"
>
  <!-- Breadcrumb -->
  <div class="flex items-center gap-2 text-sm">
    ...
    {#if selectedProject}
      <span
        class="ml-2 inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20"
      >
