...
<div class="space-y-6 max-w-6xl mx-auto">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      <div class="text-xs font-bold uppercase tracking-widest text-slate-400 mb-1">Workflow</div>
      <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-white">Live Pipeline Tracker</h1>
      <p class="text-xs sm:text-sm text-slate-400">
        Monitor real-time engine execution, stage transitions, and performance metrics via Server-Sent Events (SSE).
      </p>
    </div>
    ...
    <div class="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-6">
      <div class="flex items-center justify-between border-b border-slate-800 pb-4">
        <div class="flex items-center gap-2">
          ...
          <h2 class="text-base font-bold text-white tracking-tight">Active Engine Pipeline</h2>
        </div>
