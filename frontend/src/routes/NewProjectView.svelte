<script lang="ts">
  ...
  import { IFC_FILE_ROLES } from "../lib/types";
  import type {
    BSDDDictionaryItem,
    Project,
    DocumentItem,
...
<div class="mx-auto max-w-3xl space-y-6">
  ...
  <div class="flex flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/60">
    <!-- Step Stepper -->
    <nav
    ...
    <div class="flex-1 p-6">
      ...
      {#if currentStep === 1}
        ...
        <div class="space-y-4">
          ...
          <div>
            <span class="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-slate-300">
              Project Type
            </span>
      ...
      {:else if currentStep === 4}
        ...
        <div class="space-y-4">
          ...
          <div class="border-t border-slate-800 pt-3">
            ...
            <label for="wizard-building-code" class="mb-1.5 block text-caption font-medium text-slate-400">
      ...
      {:else if currentStep === 5}
        ...
        <div class="space-y-3">
          ...
          {#if documents.length === 0}
            <div class="rounded-xl border border-slate-800 p-6 text-center text-xs text-slate-500">
              ...
              {#each documents as doc (doc.id)}
                ...
                >
                  <div class="flex items-center gap-2.5 truncate">
                    <FileText
                      class="h-4 w-4 {selectedDocIds.has(doc.id) ? 'text-accent' : 'text-slate-500'}"
                    />
                    <div class="truncate">
          ...
          <div class="border-t border-slate-800 pt-2">
            ...
            {#if standardsForDomain.length === 0}
              <div class="rounded-xl border border-slate-800 p-4 text-center text-xs text-slate-500">
    ...
    <!-- Footer Buttons -->
    <div class="flex items-center justify-between border-t border-slate-800 bg-slate-950/60 px-6 py-4">
      {#if currentStep > 1}
        <button
          type="button"
          onclick={() => (currentStep -= 1)}
