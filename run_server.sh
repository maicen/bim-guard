...
echo -e "  ${COLOR_CYAN}➜${COLOR_RESET}  ${COLOR_BOLD}Frontend (local):${COLOR_RESET}  http://localhost:${FRONTEND_PORT}"
echo -e "  ${COLOR_CYAN}➜${COLOR_RESET}  ${COLOR_BOLD}Frontend (hostname):${COLOR_RESET} http://${MACHINE_HOSTNAME}:${FRONTEND_PORT}"
echo -e "  ${COLOR_CYAN}➜${COLOR_RESET}  ${COLOR_BOLD}Backend (local):${COLOR_RESET}   http://127.0.0.1:${BACKEND_PORT}"
echo -e "  ${COLOR_CYAN}➜${COLOR_RESET}  ${COLOR_BOLD}Backend (hostname):${COLOR_RESET} http://${MACHINE_HOSTNAME}:${BACKEND_PORT}"
echo -e "  ${COLOR_CYAN}➜${COLOR_RESET}  ${COLOR_BOLD}Docs (local):${COLOR_RESET}      http://127.0.0.1:${BACKEND_PORT}/api/docs"
