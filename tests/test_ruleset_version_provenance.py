...
#: 1.3.0 since the 2026-09-16 re-sourcing of the SB-001 brace spacing constants
#: (1.2.0 was the same-day brace angle re-sourcing; 1.1.0 was the 2026-09-13
#: provenance re-label).
SB_STAMP = "BIMGUARD-SB-001 v1.3.0"
...
def test_the_sb_stamp_is_read_from_the_config_not_written_inline():
    ...
    assert raw["metadata"]["schema_version"] == "1.3.0"
