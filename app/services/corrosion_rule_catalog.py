...
PRECEDENCE, HIGHEST FIRST
    ...
    the stored payloads: they hold fewer entries *and* different values for
    some entries they share, so a catalog built from them can band the same
    element differently (``docs/defects/corrosion-catalog-fallback-divergence.md``).
...
_FALLBACK_RULESETS: dict[str, dict[str, Any]] = {
    "galvanic_corrosion_ruleset.json": {
        ...
        "pren_thresholds": {"by_environment": {"E2_NORMAL": {"min_pren": 18, "note": "SS304 adequate"}, "E3_HUMID": {"min_pren": 25, "note": "SS316 required"}, "E5_EXPOSED": {"min_pren": 32, "note": "Duplex 2205 or better required"}, "E6_POOL": {"min_pren": 32, "note": "Duplex 2205 or better required"}}, "formula": "PREN = %Cr + 3.3 x %Mo + 16 x %N"},
    ...
    "crevice_corrosion_ruleset.json": {
        ...
        "cct_table": {"grades": {"ss316_passive": {"cct_c": 10, "label": "SS 316 / 1.4401", "pren_typical": 25}, "ss304_passive": {"cct_c": -5, "label": "SS 304 / 1.4301", "pren_typical": 19}, "duplex2205": {"cct_c": 25, "label": "Duplex 2205 / 1.4462", "pren_typical": 35}, "superduplex2507": {"cct_c": 50, "label": "Super Duplex 2507 / 1.4410", "pren_typical": 42}, "titanium": {"cct_c": 120, "label": "Titanium Grade 2", "pren_typical": 45}, "hastelloy_c": {"cct_c": 85, "label": "Hastelloy C-276", "pren_typical": 70}}},
