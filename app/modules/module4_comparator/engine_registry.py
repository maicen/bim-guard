...
class RuleEvaluator(Protocol):
    ...
    def evaluate(self, element: Any, *, context: RuleEvaluationContext | None = None) -> dict[str, Any]:
        ...
...
class CallableRuleEvaluator:
    ...
    def __init__(self, rule_type: str, evaluator: Callable[[Any], dict[str, Any]]) -> None:
...
class RuleEngineRegistry:
    ...
    def __init__(self, *, evaluators: dict[str, RuleEvaluator | Callable[[Any], dict[str, Any]]] | None = None) -> None:
    ...
    def register(
        self,
        rule_type: str,
        evaluator: RuleEvaluator | Callable[[Any], dict[str, Any]],
    ) -> RuleEvaluator:
